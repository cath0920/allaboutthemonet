...
function drawPetals(x, y, o){
        ctx.fillStyle = "hsla("+o.c+", 100%, 45%, "+o.a+")";
        ...
        ctx.beginPath();
        ctx.moveTo(x,y);
        ctx.quadraticCurveTo(x+50, y-80, x, y-80);
        ...
        ctx.beginPath();
        ctx.moveTo(x,y);
        ctx.quadraticCurveTo(x-80, y-50, x-80, y);
        ...
        ctx.beginPath();
        ctx.moveTo(x,y);
        ctx.quadraticCurveTo(x-120, y+90, x-20, y+80);
        ctx.quadraticCurveTo(x, y+80, x, y);
        ctx.closePath();
        ctx.fill();
        ...
        ctx.beginPath();
        ctx.moveTo(x,y);
        ctx.quadraticCurveTo(x+120, y+80, x+30, y+80);
        ctx.quadraticCurveTo(x, y+80, x, y);
        ctx.closePath();
        ctx.fill(); 
    };
